...
void SimpleCrypt::setCompressionMode(SimpleCrypt::CompressionMode mode)
{
    m_compressionMode = mode;
}

SimpleCrypt::CompressionMode SimpleCrypt::compressionMode() const
{
    return m_compressionMode;
}

void SimpleCrypt::setIntegrityProtectionMode(SimpleCrypt::IntegrityProtectionMode mode)
{
    m_protectionMode = mode;
}

SimpleCrypt::IntegrityProtectionMode SimpleCrypt::integrityProtectionMode() const
{
    return m_protectionMode;
}

SimpleCrypt::Error SimpleCrypt::lastError() const
{
    return m_lastError;
}
